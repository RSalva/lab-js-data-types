...
let concatenatedParts = part1.charAt(0).toUpperCase() + part1.charAt(1) + part1.charAt(2) + part1.charAt(3) + part2.charAt(0).toUpperCase() + part2.charAt(1) + part2.charAt(2) + part2.charAt(3) + part2.charAt(4) + part2.charAt(5);
